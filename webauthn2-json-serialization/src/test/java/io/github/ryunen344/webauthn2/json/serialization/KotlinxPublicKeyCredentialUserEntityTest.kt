...
class KotlinxPublicKeyCredentialUserEntityTest : PublicKeyCredentialUserEntityTest() {
    @Test
    ...
    override fun testDeserialize_givenValue_thenDeserialize() =
        runJsonTest("PublicKeyCredentialUserEntity-value.json") {
            val actual = JsonUtil.json.decodeFromString<PublicKeyCredentialUserEntity>(it)
